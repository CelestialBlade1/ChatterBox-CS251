"""
Implements the required structures for a Diffie Hellman styled 
key exchange system.
"""
...
class Crypt:
    ...
    def getPrivateKey(self, n_bits):
        return random.getrandbits(n_bits)
    
    def ModularExponentiation(self, privatekey, publicgenerator, publicmod):
        c = 1
        ee = 0
        e = privatekey
        b = publicgenerator 
